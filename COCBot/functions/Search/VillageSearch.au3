...
Func VillageSearch() ;Control for searching a village that meets conditions
	...
	If $AlertSearch = 1 Then
		TrayTip("[ " & $sCurrProfile & " ] " & $sModeText[$iMatchMode] & " Match Found!", "Gold: " & $searchGold & "; Elixir: " & $searchElixir & "; Dark: " & $searchDark & "; Trophy: " & $searchTrophy, "", 0);MMHK add profile name to tray tip
