...
Global $TrainBarb[4]        = [ 220 - 54, 310 + $midOffsetY, 0xFFB620,     40] ; MMHK ....
...
Global $TrainBall[4]        = [ 682, 459 + $midOffsetY, 0x7C1C10,     40]
...
Global $TrainPekk[4]        = [ 474, 459 + $midOffsetY, 0x395671,     40] ; .... MMHK

Global $TrainMini[4]        = [ 220, 310 + $midOffsetY, 0x182340,     40] ;  Done
Global $TrainHogs[4]        = [ 301, 310 + $midOffsetY, 0x72D0E8,     40] ;  Done 71D0E8
Global $TrainValk[4]        = [ 442, 310 + $midOffsetY, 0xC04710,     40] ;  Done A33D08 ; MMHK
...
Global $aRequestTroopsAO[6]	= [702, 299 + $midOffsetY, 0xd0eb78, 0x000100, 0xd6d6d6, 15] ; MMHK ; Button Request Troops in Army Overview  (x,y,can request, request allready made, army full/no clan, toll)

Global Const $FullBarb[4]   = [198, 375 + $midOffsetY, 0x6D6D6D, 45] ; MMHK .... ; Location of Elixir check pixel with normal color and Barrack Full color
...
Global Const $FullPekk[4]   = [507, 482 + $midOffsetY, 0x949494, 45] ; .... MMHK
...
Global Const $GemBarb[4]    = [187, 372 + $midOffsetY, 0xE70A12, 30] ; MMHK .... ; Pixel location of middle of right side of zero text for troop training, and color when out of Elixir
...
Global Const $GemPekk[4]    = [495, 475 + $midOffsetY, 0xE70A12, 30] ; .... MMHK
...
Global Const $aCloseChat[4] = [ 332, 370 + $midOffsetY, 0xc84c08, 10] ; MMHK
