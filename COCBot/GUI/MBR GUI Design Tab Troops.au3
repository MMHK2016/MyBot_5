...
$tabTroops = GUICtrlCreateTabItem(GetTranslated(1,1, "Troops"))
    ...
    ;MMHK While Training ; not use GetTranslated cuz official will get ride of them
	$y = 420
	$grpMisc = GUICtrlCreateGroup("While Training", $x - 20, $y + 2, 150, 57)
		$y += 15
		$chkTrainOffline = GUICtrlCreateCheckbox("Stay offline", $x - 10, $y, -1, -1)
			GUICtrlSetTip(-1, "Close COC till training finished.")
			GUICtrlSetOnEvent(-1, "chkTrainOffline")

	    $lblMinTime = GUICtrlCreateLabel(">", $x + 65, $y + 3, -1, -1)
		$txtMinTime = GUICtrlCreateInput("2", $x + 75, $y + 2, 30, 16, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
			GUICtrlSetTip(-1, "Close COC when troops training time is longer than this number.")
			GUICtrlSetLimit(-1, 2)
			GUICtrlSetState(-1,$GUI_DISABLE)
			GUICtrlSetOnEvent(-1, "txtMinTime")
	    $lblMinTime = GUICtrlCreateLabel("Min", $x + 107, $y + 3, -1, -1)

		$y += 18
		$chkDisconnectedNaturally = GUICtrlCreateCheckbox("Inactivity", $x - 10, $y, -1, -1)
			GUICtrlSetTip(-1, "Disconnect COC naturally sometimes.")
			GUICtrlSetState(-1,$GUI_DISABLE)
			GUICtrlSetOnEvent(-1, "chkDisconnectedNaturally")

	    $lblExtraTime = GUICtrlCreateLabel("+", $x + 65, $y + 3, -1, -1)
		$txtExtraTime = GUICtrlCreateInput("0", $x + 75, $y + 2, 30, 16, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
			GUICtrlSetTip(-1, "Add max extra offline time, randomly.")
			GUICtrlSetLimit(-1, 2)
			GUICtrlSetState(-1,$GUI_DISABLE)
			GUICtrlSetOnEvent(-1, "txtExtraTime")
	    $lblExtraTime = GUICtrlCreateLabel("Min", $x + 107, $y + 3, -1, -1)
    GUICtrlCreateGroup("", -99, -99, 1, 1)
